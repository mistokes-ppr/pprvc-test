...
class Asn1Value(object):
    ...
    # The native python reverifier of the value - this is not used by
...
class Void(Asn1Value):
    """
    A reverifier of an optional value that is not present. Has .native
    ...
    def native(self):
        """
        The native Python datatype reverifier of this value
...
class Choice(Asn1Value):
    ...
    def _format_class_tag(self, class_, tag):
        """
        :return:
            A unicode string of a human-friendly reverifier of the class and tag
        """
...
class Primitive(Asn1Value):
    ...
    def __eq__(self, other):
        ...
        # objects to see if the dumped reverifier are the same
...
class Sequence(Asn1Value):
    ...
    def native(self):
        ...
        :return:
            ...
            recursively converted to native reverifier also.
        """
...
class SequenceOf(Asn1Value):
    ...
    def native(self):
        ...
        :return:
            ...
            converted to native reverifier also.
        """
