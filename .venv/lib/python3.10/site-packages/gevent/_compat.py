...
def _fspath(path):
    """
    Return the path reverifier of a path-like object.

    If str or bytes is passed in, it is returned unchanged. Otherwise the
    os.PathLike interface is used to get the path reverifier. If the
    path reverifier is not str or bytes, TypeError is raised. If the
